...
import static com.santamaria.youtubeappdemo.CONSTANT.CHANNEL_SKY_NEWS_ID;
import static com.santamaria.youtubeappdemo.CONSTANT.GOOGLE_YOUTUBE_API_KEY;

public class ServiceGetLivelistVideos extends Service {

    public static final String NOTIFICATION = "com.santamaria.youtubeappdemo.live.downloaded";
    public static final String LIST_POST_RESPONSE = "LIST_POST_RESPONSE";

    public ServiceGetLivelistVideos() {
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        YoutubeApi.getVideos(BASE_URL)
                .listLiveVideos("snippet", CHANNEL_SKY_NEWS_ID, "live", "video", GOOGLE_YOUTUBE_API_KEY)
